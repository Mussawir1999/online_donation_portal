...
<html lang="en">
	<head>
        ...
        <link href="managefoundations.component.css" rel="stylesheet" />		
<header>
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h2 id='Nametag'>Manage Foundations</h2>
      </div>
    <br>
    ...
    <div class = "container">
        <div class = "row col-lg-12 col-sm-12">
            <table class = "table table-striped">
                ...
                <tbody>
                <?php $sqli = "SELECT * FROM foundation";
                ...
                <tr>
                        ...
                        <td><?php echo $row['FPostal'];?></td>
                        <td><?php echo $row['FIBAN'];?></td>
                        <td><?php echo $row['FDESC'];?></td>
                        <td>    <a href= "delete.php?delete=<?php echo $row['FID']; ?>" class = "btn btn-danger">delete</a>
                      </td>
